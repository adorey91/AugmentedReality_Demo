...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    /// </summary>
    public class ARInteractorSpawnTrigger_New : MonoBehaviour
    {
        /// <summary>
        ...
        void Update()
        {
            ...
            if (m_AttemptSpawn)
            {
                ...
                if (!isPointerOverUI && m_ARInteractor.TryGetCurrentARRaycastHit(out var arRaycastHit))
                {
                    ...
                    // Check if the object was successfully spawned
                    if (m_ObjectSpawner.lastSpawnedObject == null) // Check if no object has been spawned yet
                    {
                        m_ObjectSpawner.TrySpawnObject(arRaycastHit.pose.position, arPlane.normal);
                    }
                    else
                    {
                        Debug.Log("An object has already been spawned.");
                    }
